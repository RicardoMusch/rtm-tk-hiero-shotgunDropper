...
class StgkStarterApp(Application):
    ...
    def init_app(self):
        ...
        self.logger.info("- Loading Shotgun DropData callback for Hiero")
        ...
        try:
            ...
            self.logger.info("- Loaded Shotgun DropData callback for Hiero")
        except Exception as e:
            self.logger.error("- Failed to load ShotgunDropper")
            self.logger.error(e)
